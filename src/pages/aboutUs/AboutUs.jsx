  ...
  return (
    ...
    <div className="flex flex-col gap-32 my-4">
      <div
        ...
        data-aos-delay="200"
        className="headerFont gradient-text lg:text-[30px] text-[28px] lg:text-left  text-center aos-responsive"
      >
        About Us
      </div>
      <div>
        <h1
          ...
          data-aos-duration="3000"
          data-aos-delay="200"
          className="headerFont gradient-text lg:text-[30px] text-[28px] lg:text-right text-center aos-responsive"
        >
          Our Vision
        </h1>
      ...
      <div>
        <h1
          ...
          data-aos-duration="3000"
          data-aos-delay="200"
          className="headerFont lg:text-[30px] lg:text-right text-center text-[28px] aos-responsive"
        >
          Our Values
        </h1>
